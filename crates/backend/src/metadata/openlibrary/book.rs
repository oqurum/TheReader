...
pub struct BookSearchItem {
    ...
    pub ratings_count_1: Option<u32>,
    pub ratings_count_2: Option<u32>,
    pub ratings_count_3: Option<u32>,
    pub ratings_count_4: Option<u32>,
    pub ratings_count_5: Option<u32>,
    pub readinglog_count: Option<u32>,
    pub want_to_read_count: Option<u32>,
    pub already_read_count: Option<u32>,
    pub currently_reading_count: Option<u32>,
    ...
    pub id_better_world_books: Option<Vec<String>>,
